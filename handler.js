...
if (name != 'grupo-unbanchat.js' && name != 'owner-exec.js' && name != 'owner-exec2.js' && name != 'herramientas-delete.js' && chat?.isBanned && !isROwner) return 
if (m.text && user.banned && !isROwner) {
if (user.antispam > 2) return
m.reply(`*[ ☕ ] Está baneado/a, no puede usar los comandos de este bot!\n${user.bannedReason ? `\n💌 *Motivo:* 
${user.bannedReason}` : '💌 *Motivo:* Sin Especificar'}\n\n*⚠️Si crees que fue un error, contacta con mi creador:*\n> Wa.me/51927238856`)
user.antispam++        
return
}
...
global.db.data.users[m.sender].spam = new Date * 1
            ...
            continue
             ...
             m.isCommand = true
                ...
                try {
                    ...
                    if (m.estrellas)
                        conn.reply(m.chat, `Utilizaste *${+m.estrellas}* 🪙`, m)
                }
                break
            }
        }
     ...
     if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|mente|pero|tion|age|ous|ate|and|but|ify|ai|hadow|a|s)/gi)) {
...
const msg = {
rowner: `*[ ℹ️ ] Este comando solo puede ser usado por el creador del bot.*`, 
owner: `*[ ℹ️ ] Este comando solo puede ser usado por los desarrolladores del bot.*`, 
mods: `*[ ℹ️ ] Este comando solo puede ser usado por los moderadores del bot.*`, 
premium: `*[ ℹ️ ] Este comando solo puede ser usado por los usuarios premium.*`, 
group: `*[ ℹ️ ] Este comando solo puede ser usado en grupos.*`,
private: `*[ ℹ️ ] Este comando solo puede ser usado en el chat privado del bot.*`,
admin: `*[ ℹ️ ] Este comando solo puede ser usado por los administradores del grupo.*`, 
