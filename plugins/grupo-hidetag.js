...
// Codigo Segundario Notify Funcional en face de prueba by Criss7
...
const handler = async (m, {conn, text, participants, isOwner, isAdmin}) => {
  try {
    ...
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/Cj8oTiVQOvIISylM5yi5DP'}}}}}, {});
    }
  }
};
